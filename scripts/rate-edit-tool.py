...
sys.path.insert(0, str(REPO_ROOT / "python/cxn-rpc/src"))

from cxn_rpc import (  # noqa: E402
    AgentEndEvent,
    AutoRetryEndEvent,
    AutoRetryStartEvent,
    ExtensionUiRequest,
...
async def run_all(args: argparse.Namespace) -> int:
    cxn_bin = resolve_cxn_bin(args.cxn_bin)
    ...
    results_dir = (
        ...
        if args.results_dir
        else tmp_root / f"cxn-fixture-runs-{timestamp}"
    )
