...
smoke_cli() {
   ...
   XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$cxn_bin" --version
   XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$cxn_bin" --help >/dev/null
   XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$cxn_bin" stats --summary >/dev/null
   ...
   XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$cxn_bin" --smoke-test
}
...
if [ "${CXN_INSTALL_TEST_SKIP_NATIVE_BUILD:-0}" != "1" ]; then
...
utils_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-utils-*.tgz)"
wire_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-wire-*.tgz)"
omptype_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-omptype-*.tgz)"
natives_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-natives-[0-9]*.tgz)"
natives_leaf_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-natives-"$host_tag"-*.tgz)"
hashline_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-hashline-*.tgz)"
catalog_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-catalog-*.tgz)"
ai_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-ai-*.tgz)"
mnemopi_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-mnemopi-*.tgz)"
snapcompact_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-snapcompact-*.tgz)"
agent_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-agent-core-*.tgz)"
tui_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-tui-*.tgz)"
stats_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-omp-stats-*.tgz)"
coding_agent_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-pi-coding-agent-*.tgz)"
collab_web_tgz="$(find_tarball "$TARBALL_DIR"/cyberxninja-omp-collab-web-*.tgz)"
