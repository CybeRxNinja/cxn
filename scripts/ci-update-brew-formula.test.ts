...
const SUMS = {
	"cxn-darwin-arm64": "darwin_arm64_sha",
	"cxn-darwin-x64": "darwin_x64_sha",
	"cxn-linux-arm64": "linux_arm64_sha",
	"cxn-linux-x64": "linux_x64_sha",
};
...
describe("renderFormula", () => {
	...
	it("attaches `using: :nounzip` to every per-platform url stanza", () => {
		...
		for (const arch of ["cxn-darwin-arm64", "cxn-darwin-x64", "cxn-linux-arm64", "cxn-linux-x64"]) {
