...
# terminal transcript.
#
# Prepare a directory (default ~/cxn-signing) containing:
...
#   CXN_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/cxn-signing
...
DIR="${DIR:-${CXN_SIGNING_DIR:-$HOME/cxn-signing}}"
REPO="${CXN_REPO:-can1357/oh-my-pi}"
