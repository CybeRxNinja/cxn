 ...
 * to a small model (default `google-antigravity/gemini-3.7-flash` via `@cyberxninja-omp/pi-ai`)
...
import { type Api, completeSimple, Effort, type Model, type Tool, type ToolCall } from "@cyberxninja-omp/pi-ai";
import { discoverAuthStorage } from "@cyberxninja-omp/pi-ai/auth-broker";
