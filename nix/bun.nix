...
}:
{
  ...
  "@cyberxninja-omp/pi-catalog" = copyPathToStore ../packages/catalog;
  "@cyberxninja-omp/pi-coding-agent" = copyPathToStore ../packages/coding-agent;
  "@cyberxninja-omp/pi-metaharness" = copyPathToStore ../packages/metaharness;
  "@cyberxninja-omp/pi-mnemopi" = copyPathToStore ../packages/mnemopi;
  "@cyberxninja-omp/pi-natives" = copyPathToStore ../packages/natives;
  "@cyberxninja-omp/pi-tui" = copyPathToStore ../packages/tui;
  "@cyberxninja-omp/pi-utils" = copyPathToStore ../packages/utils;
  "@cyberxninja-omp/pi-wire" = copyPathToStore ../packages/wire;
  "@cyberxninja-omp/snapcompact" = copyPathToStore ../packages/snapcompact;
  "@cyberxninja-omp/typescript-edit-benchmark" = copyPathToStore ../packages/typescript-edit-benchmark;
