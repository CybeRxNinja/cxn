...
import { configureProviderMaxInFlightRequests } from "@cxn/pi-ai/stream";
import {
	getAgentDbPath,
	getAgentDir,
...
export class Settings {
	...
	#project: RawSettings = {};
	/** Last successfully loaded native .cxn/config.yml contents. */
	...
	async #loadProjectSettings(): Promise<RawSettings> {
		...
		const projectConfigPath = path.join(this.#cwd, ".cxn", "config.yml");
