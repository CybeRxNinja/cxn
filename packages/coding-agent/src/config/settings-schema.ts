...
export const SETTINGS_SCHEMA = {
	...
	"providers.maxInFlightRequests": {
		...
		ui: {
			...
			description:
				'Maximum concurrent LLM requests per provider id (for example "openai" or "anthropic"), shared across local CXN processes with this config root. Omitted providers are unlimited.',
		},
	},
	...
	"security.enabled": {
		...
		ui: {
			...
			label: "Security",
			description:
				"Enable CXN-native security scan planning, execution, and the read-only security:// resource namespace",
		},
	},
	...
	"extensionHandlers.toolCallTimeoutMs": {
		...
		ui: {
			...
			description:
				"Positive finite active-work timeout for extension tool_call handlers; invalid values use 30000ms, and time awaiting CXN-owned dialogs does not count",
		},
	},
