...
import { BracketedPasteHandler } from "@cxn/pi-tui/bracketed-paste";
 ...
 * argument list, tolerating both the cxn `(theme)` and upstream-pi
...
export class CustomEditor extends Editor {
	 ...
	 * the upstream-pi `(tui, theme, keybindings)` convention. Undefined for cxn's
	...
	/**
	 * Accept both the cxn constructor convention — `new CustomEditor(theme)` —
