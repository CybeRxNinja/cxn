 ...
 * the user run `cxn browser-relay` by hand, the relay kind lazily starts one
...
export const RELAY_DAEMON_NAME = "cxn.browser.relay";
const RELAY_BROKER_SCOPE = "browser-relay";
/** Matches the serve banner (`cxn browser relay listening on http://…`). */
