 ...
 *
 * Impersonates Chrome's CDP discovery endpoint so the cxn browser tool (and
...
/** Default appearance of the cxn tab group. */
const DEFAULT_GROUP = { title: "cxn", color: "cyan" } as const;
