...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@cxn/pi-ai";
...
// Per-provider image-count budgets live in @cxn/snapcompact
