...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `cxn grievances` invocation working unchanged
	...
	static examples = [
		"cxn grievances",
		"cxn grievances list --tool find",
		"cxn grievances clean --id 209",
		"cxn grievances clean --tool find",
		"cxn grievances clean --all",
		"cxn grievances push",
	];
