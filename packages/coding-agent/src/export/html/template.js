    (function() {
      ...
      const THEME_STORAGE_KEY = 'cxn-export-theme';
      ...
      //  - Share viewer: share-loader.js sets `window.__CXN_SESSION_DATA__` to
      ...
      // ============================================================
      //
      // Tool calls render through the bundled <cxn-tool-view> web component
      ...
      globalThis.__CXN_TOOL_VIEW_DATA = TOOL_VIEW_DATA;
      let toolViewSeq = 0;
      ...
      function renderToolCall(call, sctx) {
        ...
        return '<cxn-tool-view class="tool-execution ' + statusClass + '" data-key="' + key + '" open></cxn-tool-view>';
      }
      ...
      const pending = window.__CXN_SESSION_DATA__;
