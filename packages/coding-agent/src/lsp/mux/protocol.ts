 ...
 * each concurrent CXN link its own language-server process, then retains idle
...
export const LSP_MUX_WORKER_ARG = "__cxn_worker_lsp_mux";

/** Environment key carrying the socket endpoint the mux must listen on. */
export const LSP_MUX_SOCKET_ENV = "CXN_LSP_MUX_SOCKET";
