...
const TINY_WORKER_ARG = "__cxn_worker_tiny_inference";
const STATS_SYNC_WORKER_ARG = "__cxn_worker_stats_sync";
const TAB_WORKER_ARG = "__cxn_worker_tab";
const JS_EVAL_WORKER_ARG = "__cxn_worker_js_eval";
const JS_EVAL_PROCESS_ARG = "__cxn_worker_js_eval_process";
const STT_WORKER_ARG = "__cxn_worker_stt";
const TTS_WORKER_ARG = "__cxn_worker_tts";
const MNEMOPI_EMBED_WORKER_ARG = "__cxn_worker_mnemopi_embed";
...
export async function runCli(argv: string[]): Promise<void> {
	...
	try {
		...
		if (extracted.profile !== undefined) {
			...
			// No explicit --profile: activate any CXN_PROFILE/PI_PROFILE inherited
		...
		if (extracted.aliasName !== undefined) {
			...
			if (!profile) {
				throw new Error("--alias requires --profile <name> or CXN_PROFILE");
			}
