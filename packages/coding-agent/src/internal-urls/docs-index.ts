 ...
 * written by `gen:bundle`) — so `@cyberxninja-omp/pi-coding-agent/*` SDK consumers
 ...
 * SDK consumers importing `@cyberxninja-omp/pi-coding-agent/*` load TypeScript source, where
