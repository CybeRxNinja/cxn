/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `cxn://`, `pr://`, `rule://`, `security://`, `skill://`, `ssh://`, `vault://`, and `xd://`).
 *
...
import { OmpProtocolHandler } from "./cxn-protocol";
...
export class InternalUrlRouter {
	...
	constructor() {
		...
		// Reserved CXN-owned security-analysis namespace; vendor adapters normalize into its store.
