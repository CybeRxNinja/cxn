 ...
 * `BlobStore` keep writing to `~/.cxn/agent/...`. Reach for object storage
 * if you need those off-host too.
 */

import { createAgentSession, SessionManager, SqlSessionStorage } from "@cxn/pi-coding-agent";
import { SQL } from "bun";
...
const storage = await SqlSessionStorage.create({
	client,
	table: "cxn_session_files", // optional, this is the default
