 ...
 * - ~/.cxn/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.cxn/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.cxn/agent/extensions/ or .cxn/extensions/
