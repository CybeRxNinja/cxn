 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@cxn/pi-coding-agent";

// Discover all skills from cwd/.cxn/skills, ~/.cxn/agent/skills, etc.
