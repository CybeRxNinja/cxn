...
import { AuthStorage, type CredentialDisabledEvent } from "@cxn/pi-ai";
import * as oauthUtils from "@cxn/pi-ai/oauth";
import { ModelRegistry } from "@cxn/pi-coding-agent/config/model-registry";
import { Settings } from "@cxn/pi-coding-agent/config/settings";
import type { Extension, ExtensionError, ExtensionFactory } from "@cxn/pi-coding-agent/extensibility/extensions";
import { ExtensionRunner } from "@cxn/pi-coding-agent/extensibility/extensions";
import { ExtensionRuntime } from "@cxn/pi-coding-agent/extensibility/extensions/loader";
...
describe("createAgentSession credential_disabled subscription", () => {
	...
	const baseOptions = (dirs: SessionDirs, authStorage: AuthStorage, extensions: ExtensionFactory[] = []) => ({
		...
		// loads the developer's real ~/.cxn models config on every construction (~100ms each,
