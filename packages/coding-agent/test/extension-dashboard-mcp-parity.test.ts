...
import { initializeWithSettings, reset as resetDiscoveryCache } from "@cyberxninja-omp/pi-coding-agent/discovery";
import {
	readMCPConfigFile,
	setMcpServerEnabled,
	setServerDisabled,
} from "@cyberxninja-omp/pi-coding-agent/mcp/config-writer";
import { loadAllExtensions } from "@cyberxninja-omp/pi-coding-agent/modes/components/extensions/state-manager";
import {
