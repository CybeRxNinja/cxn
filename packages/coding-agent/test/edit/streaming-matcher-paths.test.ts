...
import { EDIT_MODE_STRATEGIES } from "@cxn/pi-coding-agent/edit/streaming";
...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule, ruleCapability } from "@cxn/pi-coding-agent/capability/rule";
