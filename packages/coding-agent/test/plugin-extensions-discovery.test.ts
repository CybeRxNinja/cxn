...
import { getAgentDir, getPluginsDir, removeSyncWithRetries, setAgentDir, TempDir } from "@cyberxninja-omp/pi-utils";

const currentPiCodingAgentPath = Bun.resolveSync("@cyberxninja-omp/pi-coding-agent", import.meta.dir);
