...
describe("modelLacksWebpSupport", () => {
	...
	test("webpExclusionForModel yields true|undefined so the CXN_NO_WEBP fallback survives", () => {
...
describe("normalizeModelContextImages model-aware WebP exclusion", () => {
	...
	test("keeps WebP for a WebP-capable model when CXN_NO_WEBP is unset", async () => {
