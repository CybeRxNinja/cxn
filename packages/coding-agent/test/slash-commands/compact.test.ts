...
import type { CompactOptions } from "@cxn/pi-coding-agent/extensibility/extensions/types";
import type { InteractiveModeContext } from "@cxn/pi-coding-agent/modes/types";
import type { CompactMode } from "@cxn/pi-coding-agent/session/compact-modes";
import {
