...
import type { CompactOptions } from "@cyberxninja-omp/pi-coding-agent/extensibility/extensions/types";
import type { InteractiveModeContext } from "@cyberxninja-omp/pi-coding-agent/modes/types";
import type { CompactMode } from "@cyberxninja-omp/pi-coding-agent/session/compact-modes";
import {
