...
import { BUILTIN_TOOL_NAMES } from "@cxn/pi-coding-agent/tools/builtin-names";

// Every shipped built-in tool that is exposed to the model in normal sessions
// must have a docs/tools/<name>.md root doc served by `cxn://`. File names use
...
describe("cxn:// root docs coverage", () => {
