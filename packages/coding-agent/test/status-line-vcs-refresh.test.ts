...
import type { StatusLineSettings } from "@cyberxninja-omp/pi-coding-agent/modes/components/status-line";
...
import type { GitHeadState, GitRefHead, GitRepository } from "@cyberxninja-omp/pi-coding-agent/utils/git";
