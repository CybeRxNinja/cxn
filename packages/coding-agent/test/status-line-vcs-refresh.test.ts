...
import type { StatusLineSettings } from "@cxn/pi-coding-agent/modes/components/status-line";
...
import type { GitHeadState, GitRefHead, GitRepository } from "@cxn/pi-coding-agent/utils/git";
