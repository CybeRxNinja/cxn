...
import { requiresApproval, resolveApproval } from "@cxn/pi-coding-agent/tools/approval";
import { githubToolRenderer } from "@cxn/pi-coding-agent/tools/gh-renderer";
...
import {
	...
	xdevDocsAll,
	xdevEntries,
} from "@cxn/pi-coding-agent/tools/xdev";
