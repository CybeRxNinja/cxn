...
const expectedTemplate: TemplateProbeResult = {
	chars: 376_316,
	bytes: 376_472,
	sha256: "e3b5eeb50b22c00150a3d62081927b655ad8d99cce727e9403a17c8e7527d181",
	stableCache: true,
	assetsRemoved: 0,
};
...
const tempRoot = fs.mkdtempSync(path.join(os.tmpdir(), "cxn-html-template-"));
...
const bundledDependencyStubs: Record<string, string> = {
	"@cyberxninja-omp/pi-utils": 'export const APP_NAME = "omp"; export const isEnoent = () => false;',
	"../../modes/theme/theme":
...
describe("HTML export template", () => {
	...
	test("composes the exact source template once and returns the cached bytes", async () => {
		...
		expect(first).toContain("const THEME_STORAGE_KEY = 'cxn-export-theme';");
