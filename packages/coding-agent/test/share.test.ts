...
describe("normalizeShareServerUrl", () => {
	test("strips trailing slashes and falls back to the default", () => {
		expect(normalizeShareServerUrl("https://my.cxn.sh/s/")).toBe("https://my.cxn.sh/s");
		expect(normalizeShareServerUrl("https://example.com/s///")).toBe("https://example.com/s");
		expect(normalizeShareServerUrl(undefined)).toBe("https://my.cxn.sh/s");
		expect(normalizeShareServerUrl("   ")).toBe("https://my.cxn.sh/s");
	});
});
