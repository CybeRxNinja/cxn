...
import { loadCapability, setDisabledProviders } from "@cyberxninja-omp/pi-coding-agent/capability";
import type { ContextFile } from "@cyberxninja-omp/pi-coding-agent/capability/context-file";
import { clearCache } from "@cyberxninja-omp/pi-coding-agent/capability/fs";
import type { Instruction } from "@cyberxninja-omp/pi-coding-agent/capability/instruction";
import type { Prompt } from "@cyberxninja-omp/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@cyberxninja-omp/pi-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@cyberxninja-omp/pi-coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@cyberxninja-omp/pi-utils";
import "@cyberxninja-omp/pi-coding-agent/capability/context-file";
import "@cyberxninja-omp/pi-coding-agent/capability/instruction";
import "@cyberxninja-omp/pi-coding-agent/capability/prompt";
import "@cyberxninja-omp/pi-coding-agent/capability/rule";
import "@cyberxninja-omp/pi-coding-agent/discovery/github";
