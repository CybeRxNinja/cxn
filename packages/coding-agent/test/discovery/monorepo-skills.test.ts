...
import type { LoadContext, LoadResult } from "@cyberxninja-omp/pi-coding-agent/capability/types";
import { scanSkillsFromDir } from "@cyberxninja-omp/pi-coding-agent/discovery/helpers";
