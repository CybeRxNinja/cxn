...
import { getConfigDirs } from "@cyberxninja-omp/pi-coding-agent/config";
import { resolveClaudePaths } from "@cyberxninja-omp/pi-coding-agent/config/claude-paths";
import { getUserPath } from "@cyberxninja-omp/pi-coding-agent/discovery/helpers";
