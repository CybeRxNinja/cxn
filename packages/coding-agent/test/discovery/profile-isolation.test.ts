...
import { type Skill, skillCapability } from "@cyberxninja-omp/pi-coding-agent/capability/skill";
import { type SlashCommand, slashCommandCapability } from "@cyberxninja-omp/pi-coding-agent/capability/slash-command";
