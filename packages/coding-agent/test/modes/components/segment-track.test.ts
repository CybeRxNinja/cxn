...
import {
	...
	type TrackSegment,
} from "@cyberxninja-omp/pi-coding-agent/modes/components/segment-track";
import { initTheme, type ThemeColor, theme } from "@cyberxninja-omp/pi-coding-agent/modes/theme/theme";
