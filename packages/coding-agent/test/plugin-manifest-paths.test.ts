...
} from "@cyberxninja-omp/pi-coding-agent/extensibility/plugins/loader";
import type { InstalledPlugin, PluginManifest } from "@cyberxninja-omp/pi-coding-agent/extensibility/plugins/types";
