...
import { EditTool, type EditToolDetails } from "@cyberxninja-omp/pi-coding-agent/edit";
...
beforeEach(async () => {
	...
	tempDir = await fs.promises.mkdtemp(path.join(os.tmpdir(), "cxn-apply-patch-multi-"));
