...
import { commands, isSubcommand, resolveCliArgv } from "@cyberxninja-omp/pi-coding-agent/cli-commands";
import { looksLikeLocalPath } from "@cyberxninja-omp/pi-coding-agent/commands/install";
...
describe("looksLikeLocalPath", () => {
	...
	test("npm specs and marketplace refs are remote", () => {
		expect(looksLikeLocalPath("@cyberxninja-omp/exa")).toBe(false);
