...
} from "@cyberxninja-omp/pi-coding-agent/capability/extension-module";
import { resetSettingsForTest, Settings } from "@cyberxninja-omp/pi-coding-agent/config/settings";
import { getCapability, initializeWithSettings } from "@cyberxninja-omp/pi-coding-agent/discovery";
import {
	discoverAndLoadExtensions,
	discoverExtensionPaths,
	loadExtensions,
} from "@cyberxninja-omp/pi-coding-agent/extensibility/extensions/loader";
import { discoverSessionExtensionPaths } from "@cyberxninja-omp/pi-coding-agent/sdk";
