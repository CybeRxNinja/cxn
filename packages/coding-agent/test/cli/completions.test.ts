...
import {
	...
	type CompletionSpec,
	generateCompletion,
} from "@cyberxninja-omp/pi-coding-agent/cli/completion-gen";
import { generateLiveCompletion } from "@cyberxninja-omp/pi-coding-agent/commands/completions";
import type { CliConfig, CommandCtor } from "@cyberxninja-omp/pi-utils/cli";
