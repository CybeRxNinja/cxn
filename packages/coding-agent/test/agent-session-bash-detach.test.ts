 ...
 * brush spawn). This test pulls the fix end-to-end through the CXN coding
 * agent stack:
 *
 *   AgentSession.prompt
 *     → Agent.prompt (real)
 ...
 * SIGTTIN/SIGTTOU the CXN host process.
 */
...
import { BashTool, type ToolSession } from "@cyberxninja-omp/pi-coding-agent/tools";
