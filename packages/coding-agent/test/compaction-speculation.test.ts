...
import type { AssistantMessage, Model, UserMessage } from "@cyberxninja-omp/pi-ai";
...
import type { CompactionMethod } from "@cyberxninja-omp/pi-coding-agent/session/compaction-methods";
import {
	SessionMaintenance,
	type SessionMaintenanceHost,
} from "@cyberxninja-omp/pi-coding-agent/session/session-maintenance";
import { SessionManager } from "@cyberxninja-omp/pi-coding-agent/session/session-manager";
import * as snapcompactModule from "@cyberxninja-omp/snapcompact";
