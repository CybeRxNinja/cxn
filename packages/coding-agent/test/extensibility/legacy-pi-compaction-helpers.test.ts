...
// `@cyberxninja-omp/pi-agent-core/compaction` and the coding-agent barrel does not
...
describe("legacy shim compaction helpers", () => {
	...
	// Issue #7174: `compact` (same `@cyberxninja-omp/pi-agent-core/compaction` module as
