...
import * as piCodingAgent from "@cyberxninja-omp/pi-coding-agent";
import { GreenCommand } from "@cyberxninja-omp/pi-coding-agent/extensibility/custom-commands/bundled/ci-green";
