...
import * as configModule from "@cyberxninja-omp/pi-coding-agent/config";
import * as shim from "@cyberxninja-omp/pi-coding-agent/extensibility/legacy-pi-coding-agent-shim";
import * as utils from "@cyberxninja-omp/pi-utils";
