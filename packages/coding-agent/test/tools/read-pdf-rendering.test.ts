...
import { ReadTool, type ReadToolDetails } from "@cyberxninja-omp/pi-coding-agent/tools/read";
import * as pdfRead from "@cyberxninja-omp/pi-coding-agent/tools/read-pdf";
