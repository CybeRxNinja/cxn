...
import * as pyKernel from "@cyberxninja-omp/pi-coding-agent/eval/py/kernel";
...
import { resolveEvalBackends } from "@cyberxninja-omp/pi-coding-agent/tools/eval-backends";
