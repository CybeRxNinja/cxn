...
import { handleArtifactHub } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/discogs";
