...
import { handleArtifactHub } from "@cxn/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@cxn/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@cxn/pi-coding-agent/web/scrapers/discogs";
