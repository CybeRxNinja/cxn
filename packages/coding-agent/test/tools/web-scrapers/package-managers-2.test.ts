...
import { handleChocolatey } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@cyberxninja-omp/pi-coding-agent/web/scrapers/terraform";
