...
import { handleChocolatey } from "@cxn/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@cxn/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@cxn/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@cxn/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@cxn/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@cxn/pi-coding-agent/web/scrapers/terraform";
