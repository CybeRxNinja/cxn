...
import { applyDisabledExtensionsToState } from "@cxn/pi-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@cxn/pi-coding-agent/modes/components/extensions/types";
