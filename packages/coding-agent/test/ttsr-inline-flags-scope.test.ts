...
import { compileRuleCondition } from "@cyberxninja-omp/pi-coding-agent/capability/rule";
import { buildRuleFromMarkdown, createSourceMeta } from "@cyberxninja-omp/pi-coding-agent/discovery/helpers";
