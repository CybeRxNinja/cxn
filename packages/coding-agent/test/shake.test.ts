...
import { Agent, type AgentMessage, RESCUE_SHAKE_CONFIG } from "@cyberxninja-omp/pi-agent-core";
import * as compactionModule from "@cyberxninja-omp/pi-agent-core/compaction";
import type { AssistantMessage, ImageContent, ToolResultMessage } from "@cyberxninja-omp/pi-ai";
