...
import { ExtensionList } from "@cyberxninja-omp/pi-coding-agent/modes/components/extensions/extension-list";
import type { Extension } from "@cyberxninja-omp/pi-coding-agent/modes/components/extensions/types";
import { HistorySearchComponent } from "@cyberxninja-omp/pi-coding-agent/modes/components/history-search";
...
import { UserMessageSelectorComponent } from "@cyberxninja-omp/pi-coding-agent/modes/components/user-message-selector";
...
import type { SessionTreeNode } from "@cyberxninja-omp/pi-coding-agent/session/session-entries";
...
async function createHistoryStorage(prompts: string[]): Promise<HistoryStorage> {
	const dir = TempDir.createSync("@cxn-history-nav-");
	tempDirs.push(dir);
	HistoryStorage.resetInstance();
