...
import type { MnemopiSessionState } from "@cyberxninja-omp/pi-coding-agent/mnemopi/state";
...
import { ManageSkillTool } from "@cyberxninja-omp/pi-coding-agent/tools/manage-skill";
