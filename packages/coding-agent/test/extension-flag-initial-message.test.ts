...
import { applyExtensionFlags, type ExtensionFlagSink } from "@cyberxninja-omp/pi-coding-agent/cli/extension-flags";
import { buildInitialMessage } from "@cyberxninja-omp/pi-coding-agent/cli/initial-message";
import {
	ExtensionRuntime,
...
import { normalizeContinueSessionArgs } from "@cyberxninja-omp/pi-coding-agent/main";
