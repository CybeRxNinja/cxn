...
import { applyExtensionFlags, type ExtensionFlagSink } from "@cxn/pi-coding-agent/cli/extension-flags";
import { buildInitialMessage } from "@cxn/pi-coding-agent/cli/initial-message";
...
import { normalizeContinueSessionArgs } from "@cxn/pi-coding-agent/main";
