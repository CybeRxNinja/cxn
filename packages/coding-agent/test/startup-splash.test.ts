...
import { runStartupSplash } from "@cxn/pi-coding-agent/modes/setup-wizard/startup-splash";
...
import { shouldShowStartupSplash } from "@cxn/pi-coding-agent/startup-splash";
