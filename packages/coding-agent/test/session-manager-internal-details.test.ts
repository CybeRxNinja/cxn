...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@cxn/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@cxn/pi-coding-agent/session/session-entries";
