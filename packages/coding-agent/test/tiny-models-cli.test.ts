...
import { resolveModels, runTinyModelsCommand } from "@cxn/pi-coding-agent/cli/tiny-models-cli";
import { TINY_LOCAL_MODELS } from "@cxn/pi-coding-agent/tiny/models";
import { tinyTitleClient } from "@cxn/pi-coding-agent/tiny/title-client";
...
describe("tiny-models download model resolution", () => {
	...
	it("prints actionable CUDA provider diagnostics from worker errors", async () => {
		...
		const diagnostic = [
			...
			"  side runtime: /home/user/.cxn/cache/tiny-title-runtime/transformers-test/node_modules",
