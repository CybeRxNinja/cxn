...
```typescript
import { encodeSixel, grep, pdfToMarkdown } from "@cxn/pi-natives";
...
`@cxn/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @cxn/pi-natives-<platform>-<arch>
