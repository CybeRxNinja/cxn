...
```typescript
import { encodeSixel, grep, pdfToMarkdown } from "@cyberxninja-omp/pi-natives";
...
`@cyberxninja-omp/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @cyberxninja-omp/pi-natives-<platform>-<arch>
