/**
 * Shared wire types for the cxn collab live-session protocol.
 *
 * Dependency-free JSON shapes produced by `@cxn/pi-coding-agent`
...
export const DEFAULT_RELAY_URL = "wss://my.cxn.sh";

/** Default share viewer/upload base; `/share` links resolve against `<base>/<id>#<key>`. */
export const DEFAULT_SHARE_URL = "https://my.cxn.sh/s";
