...
// `agent_context_usage` (claude_opus_4_8 observed at 1_000_000), but CXN's context
...
const ProjectRootNamespaceQuery = `query cxn_gitlabDuoWorkflowProjectRootNamespace($fullPath: ID!) {
...
export function buildGitLabDuoWorkflowModelSpec(
	...
	return {
		...
		// is off — this also hides CXN's thinking-effort selector for these models.
		reasoning: false,
		input: ["text"],
