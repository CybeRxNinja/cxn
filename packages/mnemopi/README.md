...
Local SQLite memory engine for cxn agents.
...
```ts
import { Mnemopi } from "@cxn/pi-mnemopi";
...
The cxn coding-agent wrapper adds `mnemopi.scoping` on top of those constructor options:
