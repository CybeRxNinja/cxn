...
import { CATEGORY_MAP, encode, PHRASE_MAP, STRUCTURAL_REPLACEMENTS } from "@cyberxninja-omp/pi-mnemopi/core/aaak";
import {
	classifyBatch,
	classifyMemory,
	getDecayRate,
	...
	MemoryType,
	shouldConsolidate,
} from "@cyberxninja-omp/pi-mnemopi/core/typed-memory";
