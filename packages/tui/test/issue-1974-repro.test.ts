...
import { type Component, CURSOR_MARKER, type NativeScrollbackLiveRegion, TUI } from "@cxn/pi-tui";
...
/**
 * Minimal append-only live region. Models the real cxn setup where
...
describe("issue #1974: tmux scrollback rendering", () => {
	...
	it("does not push chrome below the live block into pane history", async () => {
		// Models a real cxn frame: streamed assistant reply on top, persistent
