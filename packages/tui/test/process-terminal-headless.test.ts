...
import { isTerminalHeadless, setTerminalHeadless } from "@cxn/pi-utils";
...
describe("ProcessTerminal headless suppression", () => {
	...
	// #6374: arrows stopped working inside cxn and stayed broken in the shell
	// after exit — a missing cursor-key/keypad reset. cxn owns the TTY and emits
