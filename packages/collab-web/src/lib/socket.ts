 ...
 * of `@cyberxninja-omp/pi-coding-agent/src/collab/relay-client.ts` semantics).
 *
...
import type { GuestFrame, HostFrame, RelayControlMessage } from "@cyberxninja-omp/pi-wire";
