 ...
 * link/envelope half of `@cyberxninja-omp/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@cyberxninja-omp/pi-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@cyberxninja-omp/pi-wire";
