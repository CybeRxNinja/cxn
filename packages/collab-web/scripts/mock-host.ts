 ...
 * of the fixture JSONL — exactly the frames a real `cxn /collab` host emits.
 */

import type { AgentSnapshot, HostFrame, SessionEntry, SessionState, WireFrame } from "@cxn/pi-wire";
