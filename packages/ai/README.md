...
```bash
npm install @cyberxninja-omp/pi-ai
```

## Quick Start

```typescript
import { getModel, stream, complete, Context, Tool, type } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { type Tool, type } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@cyberxninja-omp/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { getModel, stream } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { Model, stream } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { getEnvApiKey } from "@cyberxninja-omp/pi-ai";
...
```typescript
import { loginGitHubCopilot } from "@cyberxninja-omp/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@cyberxninja-omp/pi-ai";
import * as fs from "node:fs";
