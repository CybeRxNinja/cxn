...
import { convertTools } from "@cxn/pi-ai/providers/google-shared";
import type { Model, TJsonSchema, Tool } from "@cxn/pi-ai/types";
import { normalizeSchemaForCCA, normalizeSchemaForGoogle } from "@cxn/pi-ai/utils/schema";
