 ...
 * that powers `cxn auth-gateway check`. Contract under test:
 *
...
import type { UsageProvider } from "@cxn/pi-ai/usage";
import * as claudeUsage from "@cxn/pi-ai/usage/claude";
import { ollamaCloudUsageProvider } from "@cxn/pi-ai/usage/ollama";
