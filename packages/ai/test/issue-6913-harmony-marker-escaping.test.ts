...
import type { ResponseInput } from "@cxn/pi-ai/providers/openai-responses-wire";
import { buildResponsesInput } from "@cxn/pi-ai/providers/openai-shared";
import type { AssistantMessage, Context, ToolResultMessage, UserMessage } from "@cxn/pi-ai/types";
import { createOpenAIResponsesHistoryPayload } from "@cxn/pi-ai/utils";
...
function harmonyPoisonedContext(): { context: Context; user: UserMessage; toolResult: ToolResultMessage } {
	...
	const toolResult: ToolResultMessage = {
		...
		toolName: "grep",
		isError: false,
		content: [{ type: "text", text: `cxn://toolconv/harmony.md: ${MARKER}\nmore docs` }],
		timestamp: 0,
	};
