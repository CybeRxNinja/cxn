/**
 * Test helper for resolving API keys from ~/.cxn/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@cxn/pi-ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@cxn/pi-ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@cxn/pi-utils";
...
/**
 * Resolve API key for a provider from ~/.cxn/agent/testauth.db
 *
