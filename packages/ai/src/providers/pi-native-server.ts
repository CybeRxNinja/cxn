 ...
 * (containerized cxn, robomp's sidecar auth-gateway).
 ...
 * `SimpleStreamOptions` from older / newer cxn builds without per-version
 * conditionals.
 */
 ...
 * targets (containerized cxn → host gateway, robomp slot → cxn-auth-gateway
