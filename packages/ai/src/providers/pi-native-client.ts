 ...
 *
 * Dispatches a {@link streamSimple}-shaped request to an `cxn auth-gateway`
 ...
 * containerized cxn deployments (such as robomp slots) that
...
/**
 * Stream a turn through an `cxn auth-gateway` over the pi-native protocol.
 *
