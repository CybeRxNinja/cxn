 ...
 * the CXN-wide stream watchdog removed in #1392: a WebSocket can stay TCP-open
...
/** Raw provider usage plus the normalized buckets CXN displays for the latest Codex turn. */
...
const CODEX_RESERVED_METADATA_KEYS: Record<string, true> = {
	...
	// mapping (#35271); CXN never emits it, but callers must not smuggle it in
	// as an extra either.
