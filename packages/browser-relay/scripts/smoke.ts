/**
 * Manual end-to-end smoke for the relay: replicates the cxn browser tool's
...
/** Puppeteer keeps the CDP target id on an internal field; same access the cxn tab supervisor uses (`targetIdForPage`). */
