/**
 * CXN Browser Relay — MV3 service worker.
 *
...
/** Dissolve every cxn-titled group (relay disconnected or asked us to release tabs). */
...
chrome.alarms.create("cxn-relay-keepalive", { periodInMinutes: 0.5 });
chrome.alarms.onAlarm.addListener(alarm => {
	if (alarm.name === "cxn-relay-keepalive") void connect();
});
