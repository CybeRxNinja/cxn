# @cyberxninja-omp/pi-metaharness
...
| `--install <source\|local\|published>` | `source` | `source` = repo bind-mount, `local` = tarball pack, `published` = npm `@cyberxninja-omp/pi-coding-agent` |
