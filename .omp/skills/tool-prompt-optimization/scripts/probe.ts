 ...
 *
 * Routes through @cyberxninja-omp/pi-ai (`completeSimple`) rather than raw HTTP so model
...
import { completeSimple } from "@cyberxninja-omp/pi-ai";
import type { Api, AssistantMessage, Model } from "@cyberxninja-omp/pi-ai";
