//! Native utilities exported via N-API for the cxn toolchain.
//!
//! # Overview
...
/// [`cxn_install_tokio_runtime`], which the JS loader calls once `dlopen` has
/// returned.
///
...
/// Guards [`cxn_install_tokio_runtime`] so the runtime is built at most once
...
pub fn cxn_install_tokio_runtime() {
	#[cfg(target_os = "windows")]
