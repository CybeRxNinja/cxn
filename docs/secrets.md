...
| Level   | Path                       | Purpose                     |
| ------- | -------------------------- | --------------------------- |
| Global  | `~/.cxn/agent/secrets.yml` | Secrets across all projects |
| Project | `<cwd>/.cxn/secrets.yml`   | Project-specific secrets    |
