...
- syntax highlighting colors used by native highlighter (`@cxn/pi-natives`)
...
- default agent dir: `~/.cxn/agent`
- effective default file: `~/.cxn/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.cxn/agent/themes/my-theme.json`.
