...
- Network
  ...
  - Headless first-use Chromium download uses the in-house `@cyberxninja-omp/pi-utils/browsers` installer.
...
- Subprocesses / native bindings
  ...
  - `killExistingByPath()` / `gracefulKillTreeOnce()` use `@cyberxninja-omp/pi-natives` process inspection/termination.
